...
function useInputId(implementation) {
  var getId = react.useCallback(function (name, ownValue) {
    ...
    if (!implementation) {
      createId = function createId() {}; // noop
...
function useMarkAsDirty() {
  var dirty = react.useRef({});
  var isDirty = react.useCallback(function (name) {
    return dirty.current[name];
  }, []);
  var setDirty = react.useCallback(function (name, value) {
...
function useFormState(initialState, options) {
  ...
  var _useMarkAsDirty = useMarkAsDirty(),
      setDirty = _useMarkAsDirty.setDirty,
      isDirty = _useMarkAsDirty.isDirty;
  ...
  var createPropsGetter = function createPropsGetter(type) {
    return function () {
      ...
      function getValidationResult(e) {
        var values = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : state;
      ...
      var inputProps = _objectSpread({
        ...
        onChange: function onChange(e) {
          ...
          if (!inputOptions.validateOnBlur) {
            setValidityState(_defineProperty({}, name, getValidationResult(e, newState)));
          }
        ...
        onBlur: function onBlur(e) {
          ...
          if (!touched[name] || isDirty(name)) {
            setValidityState(_defineProperty({}, name, getValidationResult(e)));
            setDirty(name, false);
          }
        }
  ...
  return [{
    ...
    validity: validity,
    touched: touched
  }, _objectSpread({}, inputPropsCreators, _defineProperty({}, LABEL, function (name, ownValue) {
